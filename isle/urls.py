...
urlpatterns = [
    ...
    path('load-team/<str:uid>/<int:team_id>/file-upload/', upload.FileChunkUploadTeamResult.as_view(), name='load-team-materials-file'),
    path('load-team/<str:uid>/<int:team_id>/file-upload/complete/', upload.FileChunkUploadCompleteTeamResult.as_view(), name='load-team-materials-file-complete'),
    ...
    path('load-event/<str:uid>/file-upload/', upload.FileChunkUploadEventResult.as_view(), name='load-event-materials-file'),
    path('load-event/<str:uid>/file-upload/complete/', upload.FileChunkUploadCompleteEventResult.as_view(), name='load-event-materials-file-complete'),
    ...
    path('<str:uid>/<int:unti_id>/file-upload/', upload.FileChunkUploadUserResult.as_view(), name='load-materials-file'),
    path('<str:uid>/<int:unti_id>/file-upload/complete/', upload.FileChunkUploadCompleteUserResult.as_view(), name='load-materials-file-complete'),
